...
Ex1: pr round = 0, training = fedavg (no personalization)
...
Ex2: pr round = 100, training = fedavg
...
Ex3: pr round = 0, training = fedprox (no personalization)
...
Ex4: pr round = 100, training = fedprox
